...
Hoje as áreas comuns são disputadas na base do grupo de WhatsApp, planilha ou caderninho na
portaria. Resultado: horários marcados "na palavra", confusão sobre quem reservou, faltas sem
...
- Notificações no app; instalar como **aplicativo** no celular (iPhone/Android).
- Acesso seguro: senha individual, auto-cadastro, "esqueci minha senha".
...
> **156 apartamentos.** O custo é de cerca de **R$ 2,50 por apartamento/mês** —
> cerca de R$ 30 por apartamento no ano inteiro.

| Item | Valor |
|---|---|
| **Taxa de implantação** (única, na contratação) | **R$ 500** |
| **Mensalidade — Quadra de Tênis + Mesa de Sinuca + Sala de Pilates** | **R$ 395/mês** (cerca de R$ 2,50/apartamento) |
